...
module AdvancedBilling
  ...
  class CreatePaymentProfile < BaseModel
    ...
    def initialize(chargify_token = SKIP, id = SKIP,
                   payment_type = PaymentType::CREDIT_CARD, first_name = SKIP,
                   last_name = SKIP, masked_card_number = SKIP,
                   full_number = SKIP, card_type = SKIP,
                   ...
                   billing_country = SKIP, billing_zip = SKIP,
